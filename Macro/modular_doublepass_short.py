...
layout.place_element_along_beam("Quarter_waveplate", optomech.rotation_stage_rsp05, beam, 0b11, left, 45, wave_plate_part_num = '') #421nm custom waveplates from CASIX
layout.place_element_along_beam("Lens_f_75mm_A_coat", optomech.lens_holder_l05g, beam, 0b11, left, 30, lens_part_num='LA1257-A')
layout.place_element_along_beam("Iris", optomech.pinhole_ida12, beam, 0b11, right, 10)
layout.place_element_along_beam("Retro_Mirror", mirror_mounts, beam, 0b11, right, 10)
