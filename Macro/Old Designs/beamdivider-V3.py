...
layout.place_element_along_beam("f_300_Input_Lens", optomech.lens_holder_l05g, beam, 0b101, -90, 65)

layout.place_element_along_beam("Half_waveplate_R2", optomech.rotation_stage_rsp05, beam, 0b101, -90, 70)
...
layout.place_element_along_beam("AOM_R2", optomech.isomet_1205c_on_km100pm, beam, 0b1011, 0, 50)
...
layout.place_element_along_beam("Half_waveplate_R2_Out", optomech.rotation_stage_rsp05, beam, 0b1011, 0, 15)
layout.place_element_along_beam("Iris_R2", optomech.pinhole_ida12, beam, 0b1011, 0, 20)
...
layout.place_element_along_beam("f_300_R3_Output_Lens", optomech.lens_holder_l05g, beam, 0b10101, -90, 135)
layout.place_element_along_beam("Output_Mirror_R4_3", optomech.mirror_mount_c05g, beam, 0b10101, 45, 20)
layout.place_element_along_beam("Half_waveplate_R4_Out", optomech.rotation_stage_rsp05, beam, 0b10101, 0, 30)
layout.place_element_along_beam("Iris_R4", optomech.pinhole_ida12, beam, 0b10101, 0, 20)
...
layout.place_element_along_beam("Output_Mirror_CC_R1_2", optomech.mirror_mount_c05g, beam, 0b1010001, -45, 245-(R1_out_d+R1_out_dy))
layout.place_element_along_beam("Output_Mirror_CC_R1_3", optomech.mirror_mount_c05g, beam, 0b1010001, -135, 30)
layout.place_element_along_beam("f_300_R3_Output_Lens", optomech.lens_holder_l05g, beam, 0b1010001, -90, 25)
layout.place_element_along_beam("Output_Mirror_CC_R1_4", optomech.mirror_mount_c05g, beam, 0b1010001, 45, 20)
layout.place_element_along_beam("Half_waveplate_CC_R1_Out", optomech.rotation_stage_rsp05, beam, 0b1010001, 0, 15)
layout.place_element_along_beam("Iris_R2", optomech.pinhole_ida12, beam, 0b1010001, 0, 20)
layout.place_element_along_beam("Output_Fiberport_CC_R1", optomech.fiberport_holder, beam, 0b1010001, 180, x=base_dx)
