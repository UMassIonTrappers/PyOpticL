...
def _add_linked_object(
    ...
    new_obj.addProperty("App::PropertyLinkHidden", "Baseplate").Baseplate = (
        obj.Baseplate
    )
...
class surface_adapter_lying_down:
    ...
    def __init__(
        ...
        obj.addProperty("App::PropertyLength", "AdapterHeight").AdapterHeight = (
            adapter_height
        )
        obj.addProperty("App::PropertyLength", "OuterThickness").OuterThickness = (
            outer_thickness
        )
        obj.addProperty("Part::PropertyPartShape", "DrillPart")
...
class slide_mount:
    ...
    def __init__(
        ...
        obj.addProperty("App::PropertyDistance", "DrillOffset").DrillOffset = (
            drill_offset
        )
        obj.addProperty("App::PropertyLength", "AdapterHeight").AdapterHeight = (
            adapter_height
        )
        obj.addProperty("App::PropertyLength", "PostThickness").PostThickness = (
            post_thickness
        )
        obj.addProperty("App::PropertyLength", "OuterThickness").OuterThickness = (
            outer_thickness
...
class EOM_:
    ...
    def __init__(
        ...
        obj.addProperty("App::PropertyBool", "Drill").Drill = drill
        obj.addProperty("App::PropertyAngle", "DiffractionAngle").DiffractionAngle = (
            diffraction_angle
        )
        obj.addProperty("App::PropertyInteger", "ForwardDirection").ForwardDirection = (
            forward_direction
        )
        obj.addProperty(
...
class km05_50mm_laser:
    ...
    def __init__(
        ...
        obj.addProperty("App::PropertyBool", "Drill").Drill = drill
        obj.addProperty("App::PropertyLength", "TecThickness").TecThickness = (
            tec_thickness
        )
        obj.ViewObject.ShapeColor = misc_color
...
class laser_cavity_mount_upper_plate:
    ...
    def __init__(
        ...
        obj.addProperty("App::PropertyLinkListHidden", "DrillObjects").DrillObjects = (
            drill_objs
        )
...
class km05_tec_upper_plate:
    ...
    def __init__(self, obj, drill_obj, width=inch, thickness=0.25 * inch):
        ...
        obj.addProperty("App::PropertyLength", "Width").Width = width
        obj.addProperty("App::PropertyLength", "Thickness").Thickness = thickness
        obj.addProperty("App::PropertyLinkHidden", "DrillObject").DrillObject = (
            drill_obj
        )
