...
def repump_subsystem_ECDL_mirrored(x=4, y=0, angle=0, thumbscrews=True, littrow_angle = littrow_angle):
      ECDL(x=0.3 + x, y=-4 + y, angle = 90 + angle, littrow_angle = littrow_angle) # modeling of a home-made laser
      ECDL_isolator_baseplate(x=3 + x, y=1 + y, angle=layout.cardinal['up'])
