...
def retro_unit(
    ...
    baseplate = layout.baseplate(
        ...
        angle=angle,
        mount_holes=[(2, 1), (1, 1)],
        x_offset=0.4 * layout.inch,
        y_offset=1 * layout.inch,
        gap=1 / 4 * layout.inch,
        optics_dz=optic_size,
    )
    baseplate.place_element(
        ...
        y=3 * layout.inch,
        angle=0,
        mount_type=optomech.rotation_stage_rsp1,
        diameter=optic_size,
    )
    baseplate.place_element(
        "retro mirror",
...
def turn_unit(
    ...
    baseplate = layout.baseplate(
        ...
        angle=angle,
        mount_holes=[(5, 1), (3, 1)],
        x_offset=2.4 * layout.inch,
        y_offset=0.2 * layout.inch,
        gap=layout.inch / 4,
        optics_dz=optic_size,
    )
    if type == "left":
...
def input_baseplate(
    ...
    y,
    angle,
    mirror_mount_type=optomech.mirror_mount_km05,
    addition_length=0,
    optic_size=1 * layout.inch,
):
    baseplate = layout.baseplate(
        dx=8 * layout.inch,
        dy=10 * layout.inch + addition_length,
        dz=2 * layout.inch,
        x=x,
        y=y,
        angle=angle,
        mount_holes=[(1, 0), (1, 2), (3, 0), (3, 4)],
        gap=layout.inch / 4,
        x_offset=1 * layout.inch,
        optics_dz=optic_size,
    )
    ...
    baseplate.place_element_along_beam(
        ...
        beam,
        beam_index=0b1,
        distance=2 * layout.inch + addition_length,
        angle=-135,
        mount_type=mirror_mount_type,
        diameter=optic_size,
    )
...
def MOT_2D_routing(
    x, y, angle, X=0, Y=0, optic_size=optic_size, mirror_mount_type=mirror_mount_type
):
    """
    ...
    input_baseplate(
        **p(5, 10),
        angle=0 + angle,
        addition_length=X * layout.inch,
        optic_size=optic_size,
        mirror_mount_type=mirror_mount_type
    )
    retro_unit(
        **p(5, -Y),
        angle=-90 + angle,
    ...
    retro_unit(**p(6 - X, 8), angle=180 + angle, mirror_mount_type=mirror_mount_type)
