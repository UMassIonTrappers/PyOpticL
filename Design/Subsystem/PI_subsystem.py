...
def PI_subsystem(x=0, y=0, angle=0, thumbscrews=True):
    ...
    singlepass(x=2 + x, y=14 + y, angle = 0+angle, thumbscrews=thumbscrews)
    Beam_pickoff(x=9.5 + x, y= 19 + y, angle=90+angle, thumbscrews= thumbscrews)
