...
origin.place(optomech.Chamber_with_chip("chamber",(-2 * INCH, -2 * INCH, 2.2 * INCH), (1, 1, 0)), 
                )
plate_1 = Baseplate(
                    "plate1",
                    (0, 0, 0),
...
plate_1.place(optomech.Bolt("bolt", optomech.BOLT_14_20, 1*INCH, 'clear_dia', [plate_1], (50, 50, 0), (0, 0, 0), True))
