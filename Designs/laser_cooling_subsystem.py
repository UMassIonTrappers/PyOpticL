...
laser_cooling_subsystem.add(rb_sas, position=(dim(-6, "grid"), dim(-17, "grid"), 0), rotation=90)
laser_cooling_subsystem.add(singlepass, position=(dim(-14, "grid"), dim(-6, "grid"), 0), rotation=90)
laser_cooling_subsystem.add(doublepass, position=(dim(-20, "grid"), dim(-5, "grid"), 0), rotation=90)
