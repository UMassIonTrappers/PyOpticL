...
beam = rb_sas_baseplate.add(
    ...
    rotation=(0, 0, cardinal_angle["up"]),
)
...
beam.add(
    ...
    rotation=(0, 0, turn_angle["right-up"]),
)
...
beam.add(
    ...
    rotation=(0, 0, turn_angle["left-down"]),
)
...
beam.add(
    ...
    rotation=(0, 0, turn_angle["down-left"]),
)
...
beam.add(
    ...
    rotation=(0, 0, cardinal_angle["left"]),
)
...
beam.add(
    ...
    rotation=(0, 0, turn_angle["left-up"]),
)
